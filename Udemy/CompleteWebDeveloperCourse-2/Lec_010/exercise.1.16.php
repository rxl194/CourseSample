...
<nav class="navbar navbar-default navbar-static-top navbar-padded text-uppercase app-navbar">
  <div class="container">
    ...
    <div class="navbar-collapse collapse" id="navbar-collapse">
        ...
        <a target=_blank href="/createexercise.php?clone=1&code=1.16" class="btn btn-success navbar-right" style="margin-left:10px; padding:2px 10px 3px 10px;">Clone this exercise</a>    </div><!--/.nav-collapse -->
  </div>
</nav>

    <div class="container"><h1>IFrames</h1>
        
<div id="message"></div>
        
        <p>INSTRUCTIONS: Create an IFrame to your favourite website in the below webpage.</p>
